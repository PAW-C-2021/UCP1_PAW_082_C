...
namespace UTS_DataHadir.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        public EmployeesController(DataHadirContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdEmp,Nama,Alamat,Posisi")] Employee employee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdEmp,Nama,Alamat,Posisi")] Employee employee)
        {
